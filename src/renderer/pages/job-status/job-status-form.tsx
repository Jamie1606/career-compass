...
export default function JobStatusForm({ setRefresh }: JobStatusFormProps) {
  ...
  return (
    <>
      ...
      <AddModal submitForm={submitForm} loading={loading} isOpen={isOpen} onOpenChange={onOpenChange} title="Add New Job Status" setRefresh={setRefresh} resetForm={resetForm}>
